...
public class BottomWindow {
    ...
    public void show(Activity act, int layoutResource, ViewSetting  viewSetting){
        ...
        mDetailWindow.getWindow().setLayout(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);//设置横向全屏
        mDetailWindow.show();
    }
